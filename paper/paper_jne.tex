...
\textit{Proc.} IEEE Biomed. Circuits Syst. Conf. (BioCAS), 2018, pp.~1--4.

\bibitem{babiloni2020international}
C.~Babiloni \textit{et al.},
``International 10-20, 10-10 and 10-5 systems revisited: their value for EEG electrode position nomenclature,''
\textit{Clin. Neurophysiol.}, vol.~131, no.~10, pp.~2169--2185, 2020.

\bibitem{zhang2015forehead}
Y.~Zhang, X.~Wang, and Y.~Gao,
``Forehead EEG for drowsiness detection in driving: a feasibility study,''
\textit{IEEE Trans. Intell. Transp. Syst.}, vol.~16, no.~6, pp.~3229--3238, 2015.

\bibitem{dimitriadis2021functional}
S.~Dimitriadis, A.~Pappa, and N.~Sourlas,
``Functional connectivity analysis of EEG signals for sleep stage classification: a review,''
\textit{Neural Netw.}, vol.~139, pp.~26--47, 2021.

\bibitem{kaida2006validation}
H.~Kaida, T.~Hori, T.~Kobayashi, H.~Kobayashi, and K.~Hirota,
``Validation of the Karolinska Sleepiness Scale against performance and EEG variables,''
\textit{Sleep Med.}, vol.~7, no.~3, pp.~237--243, 2006.
